  ...
  remove: function() {
    ...
    extensions2.map(normalizeExtension).forEach(function(ext) {
      ext.type.forEach(function(type) {
        var _a2, _b;
        return (_b = (_a2 = _this._removeHandlers)[type]) === null || _b === void 0 ? void 0 : _b.call(_a2, ext);
      });
    });
    return this;
  },
  ...
  handleByList: function(type, list) {
    return this.handle(type, function(extension) {
      ...
      if (type === ExtensionType.Loader) {
        (_b = (_a2 = extension.ref).add) === null || _b === void 0 ? void 0 : _b.call(_a2);
      }
    }, function(extension) {
  ...
  function() {
    ...
    BatchPluginFactory2.create = function(options) {
      var _a2 = Object.assign({
        ...
        vertexSize: 6
      }, options), vertex3 = _a2.vertex, fragment3 = _a2.fragment, vertexSize = _a2.vertexSize, geometryClass = _a2.geometryClass;
      return (
        /** @class */
        function(_super) {
...
var PlaneGeometry = (
  /** @class */
  function(_super) {
    __extends5(PlaneGeometry2, _super);
...
var RopeGeometry = (
  /** @class */
  function(_super) {
    __extends5(RopeGeometry2, _super);
...
var SimplePlane = (
  /** @class */
  function(_super) {
    __extends5(SimplePlane2, _super);
...
var NineSlicePlane = (
  /** @class */
  function(_super) {
    __extends5(NineSlicePlane2, _super);
...
@pixi/graphics/dist/esm/graphics.mjs:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-JLVGEARW.js.map
